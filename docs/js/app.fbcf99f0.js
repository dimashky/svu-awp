(function(e) {
  ...
  "56d7": function(e, t, n) {
              ...
              [
                ...
                n(
                  "v-btn",
                  {
                    ...
                    on: {
                      click: function(t) {
                        return e.$router.push({ name: "SmartAssist" });
                      }
                    }
                  },
                  [
                    n("span", { staticClass: "ml-1" }, [e._v("النظام الخبير")]),
                    n("v-icon", [e._v("mdi-heart")])
                  ],
                  1
                ),
                e.isAdmin
    ...
    var b = v,
      ...
      y = j,
      x = n("2877"),
      k = Object(x["a"])(y, o, c, !1, null, "cb98c40c", null),
      w = k.exports,
      _ = n("2f62"),
      $ = function() {
        var e = this,
      ...
      O = A,
      R = Object(x["a"])(O, $, C, !1, null, "36a1d1d8", null),
      T = R.exports,
      z = n("e096"),
      I = {
        name: "App",
        components: { Register: T, Login: w, VueRecaptcha: z["a"] },
        data: function() {
      ...
      S = I,
      q = Object(x["a"])(S, r, s, !1, null, null, null),
      E = q.exports,
      P = n("8c4f"),
      D = function() {
        var e = this,
      ...
      B = V,
      U = Object(x["a"])(B, F, H, !1, null, "7220c1d2", null),
      J = U.exports,
      Y = { name: "Home", components: { Topics: J } },
      W = Y,
      G = Object(x["a"])(W, D, L, !1, null, null, null),
      K = G.exports,
      Q = function() {
        var e = this,
          t = e.$createElement,
      ...
      re = ae,
      se = Object(x["a"])(re, Z, ee, !1, null, "2cd10ae6", null),
      ie = se.exports,
      oe = function() {
        var e = this,
          t = e.$createElement,
      ...
      ue = le,
      de = Object(x["a"])(ue, oe, ce, !1, null, "77ff8a7f", null),
      fe = de.exports,
      me = {
        name: "Consultations",
      ...
      ve = me,
      pe = Object(x["a"])(ve, Q, X, !1, null, "031bfdec", null),
      he = pe.exports,
      be = function() {
        var e = this,
          t = e.$createElement,
      ...
      ke = xe,
      we = Object(x["a"])(ke, je, ye, !1, null, "89234102", null),
      _e = we.exports,
      $e = function() {
        var e = this,
          t = e.$createElement,
      ...
      Re = Oe,
      Te = Object(x["a"])(Re, $e, Ce, !1, null, "c258b6ec", null),
      ze = Te.exports,
      Ie = {
        name: "Topics",
      ...
      Se = Ie,
      qe = Object(x["a"])(Se, be, ge, !1, null, "60f75beb", null),
      Ee = qe.exports,
      Pe = {
        state: { user: {} },
        mutations: {
    ...
    var Le = new _["a"].Store({
        ...
        return n(
          ...
          [
            n(
              "v-container",
              [
                n("div", { staticClass: "text--primary headline" }, [
                  e._v("استعلام جديد")
                ]),
                n(
                  "v-form",
                    ...
                    n(
                      ...
                      [
                        n(
                          ...
                          [
                            n("v-text-field", {
                              attrs: { type: "number", placeholder: "العمر" },
                              model: {
                                value: e.age,
                                callback: function(t) {
                                  e.age = t;
                            ...
                            n("v-select", {
                              attrs: {
                                ...
                                items: e.chestPainTypes,
                                required: ""
                              },
                              model: {
                                value: e.chestPainType,
                                callback: function(t) {
                                  e.chestPainType = t;
                                },
                                expression: "chestPainType"
                              }
                            }),
                            n("v-text-field", {
                              attrs: {
                              ...
                              model: {
                                value: e.restBloodPressure,
                                callback: function(t) {
                                  e.restBloodPressure = t;
                                },
                                expression: "restBloodPressure"
                              }
                            }),
                            n("v-select", {
                              attrs: {
                        ...
                        n(
                          ...
                          [
                            n("v-text-field", {
                              ...
                              model: {
                                value: e.maxHeartRate,
                                callback: function(t) {
                                  e.maxHeartRate = t;
                                },
                                expression: "maxHeartRate"
                              }
                            }),
                            n("v-select", {
                              attrs: {
                                ...
                                items: [
                                  ...
                                  {
                                    value: "left_vent_hyper",
                                    text: "left_vent_hyper"
                                  },
                                  {
                            ...
                            n("v-select", {
                              ...
                              model: {
                                value: e.exerciceAngina,
                                callback: function(t) {
                                  e.exerciceAngina = t;
                                },
                                expression: "exerciceAngina"
                              }
                            })
                          ],
                          1
                ...
                n("div", { staticClass: "d-flex mt-2 justify-space-around" }, [
                  n("div", { staticClass: "text--primary headline" }, [
                    e._v("النتيجة")
                  ]),
                  n(
                    ...
                    [
                      null !== e.result
                        ? n(
                            ...
                            {
                              attrs: {
                                color: !1 === e.result ? "error" : "success",
                                "x-large": ""
                              }
                            },
                            [e._v("mdi-heart")]
      ...
      Ne = {
        ...
        methods: {
          submit: function(e) {
            e.preventDefault(), (this.result = !!Math.round(Math.random()));
          }
        }
      },
      Me = Ne,
      Ve = Object(x["a"])(Me, Fe, He, !1, null, "286e0a5c", null),
      Be = Ve.exports;
    a["default"].use(P["a"]);
    var Ue = [
        { path: "/", name: "Home", component: K },
        {
          ...
          beforeEnter: function(e, t, n) {
            var a = Le.getters.isAuthenticated;
            a ? n() : n("/");
          }
        },
        { path: "/topics", name: "Topics", component: Ee },
        { path: "/smart-assist", name: "SmartAssist", component: Be }
      ],
      Je = new P["a"]({ routes: Ue }),
      Ye = Je,
      We = n("ce5b"),
      Ge = n.n(We);
    n("bf40");
    ...
    var Ke = new Ge.a({
      ...
      Qe = Ke,
      Xe = (n("d5e8"), n("5363"), n("f213")),
      Ze = (n("26e8"), n("c1df")),
      et = n.n(Ze);
    a["default"].use(Xe["b"], { toast: { position: Xe["a"].leftBottom } }),
      et.a.locale("ar"),
      (a["default"].prototype.$moment = et.a),
      ...
      Le.dispatch("checkToken").finally(function() {
        new a["default"]({
          router: Ye,
          store: Le,
          vuetify: Qe,
...
//# sourceMappingURL=app.fbcf99f0.js.map
